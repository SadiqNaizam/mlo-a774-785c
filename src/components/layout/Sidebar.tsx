...
const Sidebar: React.FC = () => {
  return (
    <aside className="w-64 flex-col bg-sidebar border-r border-sidebar-border h-screen fixed top-0 left-0 hidden lg:flex">
      <div className="p-4 border-b border-sidebar-border flex items-center justify-between h-16 flex-shrink-0">
